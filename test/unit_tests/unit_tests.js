...
(function() {
  var active_fractal, active_fractal_view, fractal_manager, target_fractal, target_fractal_view;
  ...
  target_fractal_view = new window.TargetFractalView({
  ...
  describe('TargetFractalView (with mandelbrot 400 x 285 canvas size and 4x4 sections)', function() {
    describe('getCanvasSection(coordinate: {x:int, y:int})', function() {
      it('should return the top-left section for {0,0}', function() {
        return target_fractal.getCanvasSection({
          x: 0,
          y: 0
        }).should.eql({
          x: 0,
      ...
      it('should return the bottom-left section for {399, 284}', function() {
        return target_fractal.getCanvasSection({
          x: 399,
          y: 284
        }).should.eql({
      ...
      return it('should return the appropriate section for {250, 250}', function() {
        return target_fractal.getCanvasSection({
          x: 250,
          y: 250
        }).should.eql({
    ...
    return describe('getCanvasSectionCoordinates(section: {x:int, y:int})', function() {
      it('should return the coordinates for the top left section at {0,0}', function() {
        return target_fractal.getCanvasSectionCoordinates({
          x: 0,
          y: 0
        }).should.eql({
          top_left: {
